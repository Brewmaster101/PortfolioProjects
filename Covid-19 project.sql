...
--Not all queries i have where statement saying 'continent IS NOT NULL
...
WHERE continent IS NOT NULL 
GROUP BY location
--ORDER BY total_death_count DESC; #FOR THE VISUAL ASPECT MUST TAKE OUT ORDER BY COMMAND